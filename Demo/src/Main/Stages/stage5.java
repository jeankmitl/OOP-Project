...
public class stage5 implements EnemySummoner { // Sorcerer appear
    ...
    public void summonEnemies(GamePanel game) {
        ...
        w2 = new DWait(25, e->{ //7
            ...
            game.Spawn_Enemy(new Sorcerer(0,0),2,10);
        ...
        w4 = new DWait(30, e->{//12
            ...
            game.Spawn_Enemy(new Bandit(0,0), 3, 6);
            game.Spawn_Enemy(new BanditV2(0,0), 3,8);
            game.Spawn_Enemy(new BanditV3(0,0), 2,10);
        ...
        w5 = new DWait(30, e->{//12
            ...
            game.Spawn_Enemy(new BanditV2(0,0), 4,8);
            game.Spawn_Enemy(new BanditV3(0,0), 3,10);
            game.Spawn_Enemy(new Sorcerer(0,0), 1);
            game.Spawn_Enemy(new Ninja(0, 0),3,8);
            w6.start();
        });
        w6 = new DWait(40, e->{//15
            ...
            game.Spawn_Enemy(new BanditV2(0,0), 4,8);
            game.Spawn_Enemy(new BanditV3(0,0), 3,12);
