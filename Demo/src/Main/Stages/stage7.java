...
public class stage7 implements EnemySummoner {
    ...
    public void summonEnemies(GamePanel game) {
        ...
        w5 = new DWait(35, e->{ //10
            System.out.println("Wave 5");
            game.Spawn_Enemy(new RCBomber(0, 0),5,3);
            game.Spawn_Enemy(new RobotMonoWheel(0, 0),5,5);
            w6.start();
        });
        
        w6 = new DWait(25, e->{ //13
        ...
        w7 = new DWait(35, e->{//15
            ...
            game.Spawn_Enemy(new BanditV2(0, 0), 4,6);
        });
        start.start();
    }
}
