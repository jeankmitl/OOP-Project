...
public interface StageConfig {
    ...
    StageStats STAGE_BETA = new StageStats("Stage Beta", INFINITY, 891, "cave", "dungeon_song_raid.wav"); // <- Endless future
    StageStats STAGE_TUTORIAL = new StageStats("Stage Tutorial", EASY, 14, "Stage3", "dungeon_song_raid.wav");
   // StageStats STAGE_TUTORIAL = new StageStats("Stage Tutorial", EASY, 1, "bg_dark_zone"); // test ver
    StageStats STAGE_2 = new StageStats("Stage 2", EASY, 31, "Stage3", "dungeon_song_raid.wav");//31
    StageStats STAGE_3 = new StageStats("Stage 3", EASY, 34, "Stage3", "dungeon_song_raid.wav");
    ...
    StageStats STAGE_6 = new StageStats("Stage 6", MEDIUM, 61, "bg_dark_greek", "dungeon_song_raid_nightRemix.wav");
