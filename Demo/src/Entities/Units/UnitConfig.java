...
public interface UnitConfig {
    ...
    UnitStats BIGBALL_STATS = new UnitStats(BIGBALL_SPRITE, 300, 300, 10, 400, 30, ATTACKER, BIGBALL);
    ...
    UnitStats VAMPIRE_STATS = new UnitStats(VAMPIRE_SPRITE, 300, -20, 5, 100, 7, SUPPORT, VAMPIRE_DESC);
    // Not for Operator
