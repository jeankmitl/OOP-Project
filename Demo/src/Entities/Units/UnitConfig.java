...
public interface UnitConfig {
    ...
    UnitStats GIVEAWAY_SLIME_STATS = new UnitStats(GIVEAWAY_SLIME_SPRITE, 1, 30, 0.5, 10, 30, COST_GEN);
    UnitStats MIPYA_STATS = new UnitStats(MIPYA_SPRITE, 50, 10, 1.5, 100, 30, ATTACKER, MIPYA_DESC);
    UnitStats SNAKE_STATS = new UnitStats(SNAKE_SPRITE, 350, 35, 99, 175, 25, GUARD, SNAKE_DESC);
    ...
    UnitStats VAMPIRE_STATS = new UnitStats(VAMPIRE_SPRITE, 300, -75, 5, 100, 7, SUPPORT, VAMPIRE_DESC);
    // Not for Operator
